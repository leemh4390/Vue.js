<template>
    ...
    <hr>
    <h4>2) 컴포넌트 통신(데이터 교환)</h4>
    <UComponent1 v-bind:name="name" v-bind:age="age"></UComponent1>
    ...
    <hr>
    <h4>2) 컴포넌트 생명주기</h4>
    <NewComponentVue v-if="isShow"></NewComponentVue>
 ...
 *  - 주요 구성요소 Options API 를 이용한 컴포넌트 기능 구현
 *  
 */
...
import NewComponentVue from "./components/sub4/NewComponent.vue";
